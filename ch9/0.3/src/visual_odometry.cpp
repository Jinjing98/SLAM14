...
//the descriptor for current frame is always from computing, the descriptor for ref fram is filtered from the history of "curren frams".
bool VisualOdometry::addFrame(Frame::Ptr frame){
    switch(state_){
        ...
        case LOST:{
            cout<<"it is lost of this frame"<<endl;
            break;
...
void VisualOdometry::featureMatching(){
    ...
    cout<<"all matches number is "<<matches.size()<<endl;
    cout<<"good matches number is "<<feature_matches_.size()<<endl;
}
