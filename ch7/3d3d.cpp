...
int main(int argc, char **argv){
    ...
    cout<<"3d3d   "<<pts1.size()<<endl;
    
    Mat R,t;
    
    //JacobiSVD
    pose_estimation_3d3d(pts1,pts2,R,t);
    cout<<"svd  "<<R.t()<<"  "<<-R.t()*t<<endl;  
...
void bundleAdjustment(const vector<cv::Point3f>& pts1, const vector<cv::Point3f>& pts2, cv::Mat& R, cv::Mat& t)
{
    ...
    auto solver = new g2o::OptimizationAlgorithmLevenberg(g2o::make_unique<BlockSolverType>(g2o::make_unique<LinearSolveType>()));
    ...
    pose->setId(0);
    pose->setEstimate(Sophus::SE3());   //the initial matrix is 0 of sophus>>se3(),
